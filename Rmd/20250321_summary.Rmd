...
clients = read.csv("/Users/stephanielepp/Desktop/BioinformaticsCore/bussiness_summaries/clients.csv")

invoiced = 
  readxl::read_excel("/Users/stephanielepp/Desktop/BioinformaticsCore/bussiness_summaries/invoiced.xlsx") %>%
...
ggplot(tally_date, aes(x = as.factor(Quarter), y = n, fill = Service.Type, label = n)) +
  geom_bar(stat = "identity") +
  scale_fill_manual(values = msu_pallet[1:4]) +
...
```{r, echo=FALSE, eval=T, message=FALSE}
office_hours =
  read.csv("/Users/stephanielepp/Desktop/BioinformaticsCore/bussiness_summaries/Bioinformatics_Core_Help_Hours.csv") %>%
  filter(!is.na(Name))
