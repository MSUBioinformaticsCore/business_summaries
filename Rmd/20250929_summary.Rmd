...
We have invoiced `r nrow(invoiced)` data analysis projects, totaling `r paste0("$", prettyNum(sum(invoiced$Total.Cost, na.rm = TRUE), big.mark = ",", digits=2))` with a median cost of `r paste0("$", prettyNum(median(invoiced$Total.Cost, na.rm = TRUE), big.mark = ",", digits=2))` per project.
